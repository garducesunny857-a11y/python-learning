...
print("Im sorry its unfortunate that the dinner table won't arrive on time and I can only invite 2 people\n")

popped_guess = invited_guest.pop()
print(f"{popped_guess}, Im really sorry that I cant invite you to the dinner")
...
popped_guess = invited_guest.pop()
print(f"{popped_guess}, Im really sorry I cant invite you to the dinner\n")

print(f"{invited_guest[-1]} you are still invited")
print(f"{invited_guest[0]} you are still invited")
...
print(f"Number of guests invited: {len(invited_guest)}")